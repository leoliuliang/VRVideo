...
/**
 * Interface which all rendering surfaces must implement so that {@link RRenderer} may send
 * the few control signals it needs.
 *
 * @author Jared Woolston (jwoolston@tenkiv.com)
 */
public interface IRSurface {
    ...
    /**
     * Called to set the {@link IRSurfaceRenderer} which will render on this surface.
     *
     * @param renderer {@link IRSurfaceRenderer} instance.
