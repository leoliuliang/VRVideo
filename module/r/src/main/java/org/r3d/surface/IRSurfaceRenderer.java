...
/**
 * Interface that a class must implement to be able to render to an {@link IRSurface}. Most often you will want
 * to simply extend {@link RRenderer} which handles much of this for you.
 *
 * @author Jared Woolston (jwoolston@tenkiv.com)
 */
public interface IRSurfaceRenderer {
     ...
     *
     * @param config {@link IRSurface.ANTI_ALIASING_CONFIG} The desired anti aliasing configuration.
     */
    public void setAntiAliasingMode(IRSurface.ANTI_ALIASING_CONFIG config);

    /**
     * Sets the {@link IRSurface} which this implementation will be rendering on.
     *
     * @param surface {@link IRSurface} The rendering surface.
     */
