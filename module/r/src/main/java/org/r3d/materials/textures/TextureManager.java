 ...
 */
package org.r3d.materials.textures;

import java.util.Collections;
import java.util.List;
import java.util.concurrent.CopyOnWriteArrayList;

import org.r3d.materials.AResourceManager;
...
public final class TextureManager extends AResourceManager {
	...
	private TextureManager()
	{
		...
		mRenderers = Collections.synchronizedList(new CopyOnWriteArrayList<RRenderer>());
	}
	...
	/**
	 * Adds a {@link ATexture} to the TextureManager. This should only be called by {@link RRenderer}.
	 * 
	 * @param texture
	 */
	...
	/**
	 * Replaces an existing {@link ATexture}. This should only be called by {@link RRenderer}.
	 * 
	 * @param texture
	 * @return
	 */
	...
	/**
	 * Removes a {@link ATexture} from the TextureManager. This should only be called by {@link RRenderer}.
	 * 
	 * @param texture
	 * @return
	 */
	...
	/**
	 * Completely resets the TextureManager. This should only be called by {@link RRenderer}.
	 */
	 ...
	 * @param renderer
	 */
	public void taskReset(RRenderer renderer) {
		if (mRenderers.size() == 0) {
			taskReset();
		}
	}
