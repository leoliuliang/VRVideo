...
import org.r3d.bounds.BoundingBox;
import org.r3d.bounds.BoundingSphere;
 ...
 * // on the device it runs on. (See RRenderer.supportsUIntBuffers)
 * FloatBuffer indices = geom.getIndices();
 * ShortBuffer indices = geom.getIndices();
 * </pre></code>
 *
 * @see RRenderer.supportsUIntBuffers
 * @author dennis.ippel
 *
 */
public class Geometry3D {
    ...
    public void createBuffers() {
        boolean supportsUIntBuffers = RRenderer.supportsUIntBuffers;
