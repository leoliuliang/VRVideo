 ...
 */
package org.r3d.renderer.plugins;
...
import org.r3d.extras.LensFlare;
import org.r3d.extras.LensFlare.FlareInfo;
import org.r3d.materials.textures.ASingleTexture;
...
public final class LensFlarePlugin extends Plugin {
	...
	public LensFlarePlugin(RRenderer renderer) {
		this(renderer, true);
	}

    public LensFlarePlugin(RRenderer renderer, boolean createVBOs) {
