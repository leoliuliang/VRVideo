...
import org.r3d.math.vector.Vector3.Axis;
 ...
 *
 */
public abstract class RSideBySideRenderer extends RRenderer {
	/**
	 ...
	 * right eye.
	 */
	private RScene mSideBySideScene;
	/**
	...
	public RSideBySideRenderer(Context context)
	{
		super(context);
	}

	public RSideBySideRenderer(Context context, double pupilDistance)
	{
		this(context);
	...
	public void initScene() {
		...
		mSideBySideScene = new RScene(this);
