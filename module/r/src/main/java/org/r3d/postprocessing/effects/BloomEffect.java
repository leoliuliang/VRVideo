...
import org.r3d.postprocessing.passes.BlendPass;
import org.r3d.postprocessing.passes.BlendPass.BlendMode;
import org.r3d.postprocessing.passes.BlurPass.Direction;
import org.r3d.postprocessing.passes.BlurPass;
import org.r3d.postprocessing.passes.ColorThresholdPass;
import org.r3d.postprocessing.passes.CopyToNewRenderTargetPass;
import org.r3d.postprocessing.passes.RenderPass;
...
public class BloomEffect extends APostProcessingEffect {
	 ...
	 * @param blendMode
	 */
	public BloomEffect(RScene scene, Camera camera, int width, int height, int lowerThreshold, int upperThreshold, BlendMode blendMode) {
		super();
		mScene = scene;
		mCamera = camera;
		mWidth = width;
