...
public class MaskPass extends APass {
	...
	@Override
	public void render(RScene scene, RRenderer render, ScreenQuad screenQuad, RenderTarget writeBuffer, RenderTarget readBuffer, long ellapsedTime, double deltaTime) {
